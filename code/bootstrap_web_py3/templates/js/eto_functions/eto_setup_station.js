...
class Station_Setup 
{
   ...
   load_controls( self )
   {
     ...
     $("#station_radius_field").on("input", "#station_tree_radius", self.tree_radius_change) 
     $("#station_rate_field").on("input", "#station_sprayer_rate", self.sprayer_rate_change) 
   ...
   save_control()
   {
       ...
       if( result == true )
       {
          ...
          {    
              ...
              station_control_class.reference_data["tree_radius"] =  $("#station_tree_radius").val()
              station_control_class.reference_data["sprayer_rate"] = $("#station_sprayer_rate").val()
